...
#Set default hash
client_bio = {name: "", age: 1, decor_theme: "", childnum: = 0, new_baby: false, new_property: false, other_reason: "", budget: = 50000, paid: = 0}
p client_bio
...
#If project doesnt include nursery or new property ask for brief description (convert to string and add for key other_reason)
if ~(client_bio[:new_baby] || client_bio[:new_property])
